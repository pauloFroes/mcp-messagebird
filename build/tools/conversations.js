...
export function registerConversationTools(server) {
    ...
    server.registerTool("list_conversations", {
        ...
        description: "List all conversations. Returns paginated list of conversation threads across all channels.",
        inputSchema: {
    ...
    server.registerTool("list_conversation_messages", {
        ...
        try {
            const data = await apiRequest(`/conversations/${conversation_id}/messages`, "GET", undefined, { offset, limit });
            return toolResult(data);
        }
        catch (error) {
    ...
    server.registerTool("list_messages", {
        ...
        description: "List messages across all conversations. Useful for searching or monitoring all messaging activity.",
        inputSchema: {
            offset: z.string().optional().describe("Number of items to skip (default: 0)"),
            limit: z.string().optional().describe("Max items per page (default: 20)"),
        },
